...
- **LN डेवलपर मीटिंग का सारांश:** Olaoluwa Osuntokun ने पिछले सप्ताह Oakland में LN देव मीटिंग का [विस्तृत सारांश][osuntokun summary] प्रदान किया।
  शामिल विषयों में शामिल हैं:
    ...
    - *टैपरूट-आधारित LN चैनल:* प्रतिभागियों ने LN को [टैपरूट]​​[topic taproot]
    ...
    - *TapScript और MuSig2:* टैपरूट-आधारित चैनलों पर स्विच के हिस्से के रूप में, मौजूदा स्क्रिप्ट को
    ...
    - *गॉसिप नेटवर्क अपडेट:* बैठक ने LN गपशप को अद्यतन करने के बारे में मौजूदा
      ...
      MuSig2-आधारित टैपरूट चैनलों का समर्थन करने के लिए प्रोटोकॉल के एक छोटे से उन्नयन
    ...
    - *ब्लाइंड  हुए रास्ते:* कई साल पहले प्रस्तावित एक तकनीक (देखें [Newsletter #85][news85 blinded])
...
- [BDK #593][][rust bitcoin][Rust Bitcoin repo] 0.28 का उपयोग करना शुरू करता है, जिसमें [टैपरोट][topic taproot]
  और टैपरूट [आउटपुट स्क्रिप्ट डिस्क्रिप्टर][topic descriptors] के लिए समर्थन शामिल है।
